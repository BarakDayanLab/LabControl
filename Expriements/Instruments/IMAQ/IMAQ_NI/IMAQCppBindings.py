...
IMAQ_Img_Create_Buffer = bind(lib,"imgCreateBuffer",[SESSION_ID, c_uint32, c_uint32, POINTER(c_void_p)], c_int32)
IMAQ_Img_Dispose_Buffer = bind(lib,"imgDisposeBuffer",[c_void_p],c_int32)